 ...
 */
// prettier-ignore -- one entry per line keeps the sourced table reviewable
...
export const MODULE_PRESETS: readonly ModulePreset[] = [
  ...
  {
    id: 'c108-1722x1134',
    label: 'Typ. 108 Zellen · 1722×1134 mm · 425 Wp',
    length: 113.4,
    width: 172.2,
    powerWp: 425,
    cells: 108,
  ...
  {
    id: 'c120-1755x1038',
    label: 'Typ. 120 Zellen · 1755×1038 mm · 365 Wp',
    length: 103.8,
    width: 175.5,
    powerWp: 365,
    cells: 120,
  ...
  {
    id: 'c144-1762x1134',
    label: 'Typ. 144 Zellen · 1762×1134 mm · 430 Wp',
    length: 113.4,
    width: 176.2,
    powerWp: 430,
    cells: 144,
  ...
  {
    id: 'c108-1961x1134',
    label: 'Typ. 108 Zellen · 1961×1134 mm · 490 Wp',
    length: 113.4,
    width: 196.1,
    powerWp: 490,
    cells: 108,
  ...
  {
    id: 'c144-2278x1134',
    label: 'Typ. 144 Zellen · 2278×1134 mm · 590 Wp',
    length: 113.4,
    width: 227.8,
    powerWp: 590,
    cells: 144,
...
export function findLocationPreset(
  loc: Pick<LocationConfig, 'latitude' | 'longitude'>,
...
export function findModulePreset(
  panels: Pick<PanelConfig, 'length' | 'width' | 'powerWp'>,
