...
export function MonthlyTable() {
  ...
  const exportCsv = (): void => {
    ...
    downloadText(csv, `${safeFilename(`${t.filename}-${locationName}-${simulation.year}`)}.csv`, CSV_MIME, {
      bom: true,
    });
  };
