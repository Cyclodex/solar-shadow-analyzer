...
- **Teilen und Export:** Teilen-Link (`#c=…`, mit dem genauen Standort und den Umgebungsgebäuden), Konfiguration
  als JSON speichern und laden, CSV (Monatsertrag je Stockwerk, Neigungsvergleich, Heatmap), PNG je Ansicht und
  Diagramm, Druckbericht (auch als PDF; mit Adresse, Lage am Gebäude, Umgebungsgebäuden und Laserscan).
